...
private:
    // Constants
    static constexpr double C = 299792458; // In m/s;
    static constexpr double Boltzmann = -228.6; // In dBWs/K
    static constexpr double EarthRadius = 6378.137764899274; // In km
